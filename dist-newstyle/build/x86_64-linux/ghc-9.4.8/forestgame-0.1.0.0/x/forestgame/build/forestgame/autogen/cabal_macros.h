...
/* package forestgame-0.1.0.0 */
#ifndef VERSION_forestgame
#define VERSION_forestgame "0.1.0.0"
#endif /* VERSION_forestgame */
#ifndef MIN_VERSION_forestgame
#define MIN_VERSION_forestgame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_forestgame */
...
#define CURRENT_COMPONENT_ID "forestgame-0.1.0.0-inplace-forestgame"
